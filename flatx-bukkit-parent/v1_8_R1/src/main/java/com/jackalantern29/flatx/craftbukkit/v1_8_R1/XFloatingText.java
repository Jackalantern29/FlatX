package com.jackalantern29.flatx.craftbukkit.v1_8_R1;
...
/*        this.location = location;
    ...
    public void addPlayer(Player player) {
        if(!map.containsKey(player)) {
            CraftArmorStand armorStand = (CraftArmorStand) new EntityArmorStand(((CraftWorld)location.getWorld()).getHandle(), location.getX(), location.getY(), location.getZ()).getBukkitEntity();
