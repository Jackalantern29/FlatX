package com.jackalantern29.flatx.craftbukkit.v1_16_R1;

import com.jackalantern29.flatx.api.FlatLocation;
import com.jackalantern29.flatx.craftbukkit.flatten.FlattenWorld;
import org.bukkit.Particle;
import org.bukkit.World;

public class XWorld extends FlattenWorld {
    ...
    public <T> void spawnParticle(Particle particle, double x, double y, double z, int count, double offsetX, double offsetY, double offsetZ, double extra, T data, boolean force) {
        toBukkit().spawnParticle(particle, x, y, z, count, offsetX, offsetY, offsetZ, extra, data, force);
    }
}
